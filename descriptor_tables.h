...
// A Task State Segment is a structure that sets the stack
// for the kernel in kernel mode. When a software interrupt 
// occurs in the form of a system call, the processor looks 
// up the current Task State Segment and modifies the SS and ESP
// registers to whatever it finds in the SS0 and ESP0 fields of
// that particular Task State Segment. Rather than having
// several Task State Segments, we will only have one.
